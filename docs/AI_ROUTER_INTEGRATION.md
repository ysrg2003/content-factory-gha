...
للحصول على مفاتيح Gemini أو Hugging Face، وتخزينها وتدويرها خطوةً خطوة، ابدأ بـ**[دليل الاعتمادات والمتغيرات](CREDENTIALS.md)**. يركز هذا الملف على سلوك الموجّه داخل المشروع بعد إكمال الاعتمادات.
